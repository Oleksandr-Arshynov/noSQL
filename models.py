...
from mongoengine import connect, Document, StringField, ReferenceField, ListField, EmailField, BooleanField, CASCADE
...
class Contact(Document):
    ...
    notification_preference = StringField(choices=["SMS", "Email"], required=True, default="Email")
